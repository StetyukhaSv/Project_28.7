...
public class XlsReader {
    ...
    public static List<University> readXlsUniversities(String filePath) {
        ...
        try {
            logger.log(Level.INFO, "Started reading in Excel format");
            ...
            logger.log(Level.SEVERE, "Couldn't read in Excel format", e);
            return universities;
        }
        logger.log(Level.INFO, "Reading in Excel format completed");
        return universities;
    }
